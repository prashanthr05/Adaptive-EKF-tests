...
[model,tMax,leg_ft,foot_ft,skin,inertial,transforms] = modelSensorParams_completeLeg(whichLeg,whichSkin,numberOfExperiment,t_max,model);
...
if(strcmp(measurementType,'withoutSkin')==1)
    ...
    yMeas = [a;omega';fo;muo;fc;muc]';
        ...
        yMeas = [a;omega';fo;muo;fc;muc;fc_z]';
            ...
            k = model.k;
            c = model.c;
            model.x0 = [zeros(3,1);zeros(3,1);fo(:,1);muo(:,1);fc(:,1);muc(:,1);model.phi0;k;c];
