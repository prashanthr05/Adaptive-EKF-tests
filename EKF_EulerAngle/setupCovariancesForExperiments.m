function [kalmanQParams,kalmanRParams,k,c] = setupCovariancesForExperiments(filter);
...
kalmanQParams = [4.0,	0.5,	2.0,	2.0,	0.025,	0.001595, 0.00000125];
else if(strcmp(filter,'dekf') == 1)
% kalmanQParams = [0.005,	0.0005,	0.05,	0.05,	0.00, 5, 0.125];  % acceptable params ----> DEKF,JEKF
    kalmanQParams = [4.0,	0.5,	2.0,	2.0,	0.025,	5, 1.25];  
    end
end
