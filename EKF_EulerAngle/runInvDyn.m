...
setup.k = [0.0,5.0,0.0]; %just for definition ---> set properly in invDyn
setup.c = [0.0,1.0,0.0]; %just for definition ---> set properly in invDyn
...
if(strcmp(model.invDynPlots,'makePlots') == 1)
    ...
    print('-djpeg','-r200','./plots/InvDyn/InvrseDynamicsForces','-opengl');
    ...
    set(gca,'FontSize',12);
    set(gcf,'Renderer','OpenGL');
    print('-djpeg','-r200','./plots/InvDyn/InvrseDynamicsMoments','-opengl');
    ...
    set(gca,'FontSize',12);
    set(gcf,'Renderer','OpenGL');
    print('-djpeg','-r200','./plots/InvDyn/a&omega','-opengl');
    ...
    set(gca,'FontSize',12);
    set(gcf,'Renderer','OpenGL');
    print('-djpeg','-r200','./plots/InvDyn/OrientationVelTraj','-opengl');
end
...
if(strcmp(model.measurementPlots,'makePlots') == 1)
    ...
    set(gca,'FontSize',12);
    set(gcf,'Renderer','OpenGL');
    print('-depsc2','-r200','./plots/InvDyn/MeasForces','-opengl');
    ...
    set(gca,'FontSize',12);
    set(gcf,'Renderer','OpenGL');
    print('-depsc2','-r200','./plots/InvDyn/MeasMoments','-opengl');
    ...
    set(gca,'FontSize',12);
    set(gcf,'Renderer','OpenGL');
    print('-depsc2','-r200','./plots/InvDyn/MeasIMU','-opengl');
    ...
    set(gca,'FontSize',12);
    set(gcf,'Renderer','OpenGL');
    print('-depsc2','-r200','./plots/InvDyn/MeasNormalSkin','-opengl');
