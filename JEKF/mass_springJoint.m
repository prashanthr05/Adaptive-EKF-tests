...
z0 = [x_ic v_ic f_ic k1_ic k2_ic c_ic];
...
h_func = @outputJointState;
df_dx_func = @derivativeForwardDynamicsJointState;
dh_dx_func = @derivativeOutputJointState;


%% Initialize the covariance matrices,

P = diag([0.001,0.0001,0.001,0.001,0.001,0.00]);    % NxN state covariance matrix
Q = diag([0.0,0.0,0.0025,0.000125,0.0000075,0.0007]);   % randomly assumed Process noise covariance - design parameter for the filter performance
