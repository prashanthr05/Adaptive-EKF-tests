...
% Tweaked from original, dataSet - old datasetAge - 7; dataSet - new datasetAge -1,2,3,4 (complaint dataset)

function [com_R_imu] = computeOptimalIMURotation(dataSet,datasetAge,aCalib, plots, verboseMode)
tic;
fName = sprintf('IMUOffset_%sdata%d.mat',dataSet,datasetAge);
...
%         end
    ...
    save(sprintf('./IMUOffset_%sdata%d.mat',dataSet,datasetAge),'com_R_imu');
   end
