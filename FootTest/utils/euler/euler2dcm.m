...
if nargin<2
    ...
    Ralpha = [cos(alpha) -sin(alpha) 0;...
              sin(alpha)  cos(alpha) 0;...
                      0           0  1];
    Rupsilon = [cos(upsilon) 0 sin(upsilon);...
                          0  1            0;...
               -sin(upsilon) 0 cos(upsilon)];
  
    Rpsi = [cos(psi) -sin(psi) 0;...
            sin(psi)  cos(psi) 0;...
                0           0  1];
    
    R    = Ralpha*Rupsilon*Rpsi; 

%     R    =  [cos(alpha)*cos(upsilon)*cos(psi)-sin(alpha)*sin(psi)   -cos(alpha)*cos(upsilon)*sin(psi)-sin(alpha)*cos(psi)   cos(alpha)*sin(upsilon);...
%              sin(alpha)*cos(upsilon)*cos(psi)+cos(alpha)*sin(psi)   -sin(alpha)*cos(upsilon)*sin(psi)+cos(alpha)*cos(psi)   sin(alpha)*sin(upsilon);...
%                        -sin(upsilon)*cos(psi)                                   sin(upsilon)*sin(psi)                       cos(upsilon)];
