...
matlabFunction(f_withCompliance,'file','./../dynamicsFunctions/processODE_withCompliance','vars',[x_withCompliance; phi0; dI; m; G_g]);
matlabFunction(df_dx_withCompliance,'file','./dynamicsDerivatives_withCompliance','vars',[x_withCompliance; phi0; dI; m; G_g]);

matlabFunction(f_withoutCompliance,'file','./../dynamicsFunctions/processODE_withoutCompliance','vars',[x_withoutCompliance; w; phi0; dI; m; G_g]);
...
%Foot No Compliance
matlabFunction(h_FNC_withoutSkin,'file','./../dynamicsFunctions/measurementFNC_withoutSkin','vars',[x_withoutCompliance; w; phi0; dI; m; G_g]);
matlabFunction(dh_dx_FNC_withoutSkin,'file','./outputsDerivativesFNC_withoutSkin','vars',[x_withoutCompliance; w; phi0; dI; m; G_g]);

matlabFunction(h_FNC_withSkin,'file','./../dynamicsFunctions/measurementFNC_withSkin','vars',[x_withoutCompliance; w; phi0; dI; m; G_g]);
matlabFunction(dh_dx_FNC_withSkin,'file','./outputsDerivativesFNC_withSkin','vars',[x_withoutCompliance; w; phi0; dI; m; G_g]);

%Foot With Compliance
matlabFunction(h_FC_withoutSkin,'file','./../dynamicsFunctions/measurementFC_withoutSkin','vars',[x_withCompliance; phi0; dI; m; G_g]);
matlabFunction(dh_dx_FC_withoutSkin,'file','./outputsDerivativesFC_withoutSkin','vars',[x_withCompliance; phi0; dI; m; G_g]);

matlabFunction(h_FC_withSkin,'file','./../dynamicsFunctions/measurementFC_withSkin','vars',[x_withCompliance; phi0; dI; m; G_g]);
matlabFunction(dh_dx_FC_withSkin,'file','./outputsDerivativesFC_withSkin','vars',[x_withCompliance; phi0; dI; m; G_g]);
